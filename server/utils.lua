...
lib.callback.register('hw_devmenumenu:callback:CheckPerms', function(source, perms)
    return CheckPerms(perms)
end)

lib.callback.register('hw_devmenumenu:callback:CheckAlreadyPlate', function (_, vPlate )
    return CheckAlreadyPlate( vPlate )
end)

lib.callback.register('hw_devmenumenu:callback:GetESXItems', function ()
...
lib.callback.register('hw_devmenumenu:callback:GetESXJobs', function ()
