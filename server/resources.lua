...
lib.callback.register('hw_devmenumenu:callback:GetResources', function(source)
...
lib.callback.register('hw_devmenumenu:callback:ChangeResourceState', function(source, data, perms)
