...
-- Staff Chat
RegisterNetEvent('hw_devmenumenu:server:sendMessageServer', function(message, citizenid, fullname)
...
lib.callback.register('hw_devmenumenu:callback:GetMessages', function(source)
    return messages
end)