...
RegisterNetEvent('hw_devmenumenu:requestSpectate', function(targetPed, target, name)
...
RegisterNetEvent('hw_devmenumenu:cancelSpectate', function()
    ...
    while true do
        ...
        if spectateInfo['toggled'] then
            ...
            if DoesEntityExist(targetPed) then
                ...
                TriggerServerEvent('hw_devmenumenu:spectate:teleport', spectateInfo['target'])
